...
void Sample3DSceneRenderer::ReleaseDeviceDependentResources(void)
{
	...
	c_vertexShader.Reset();
	t_hullShader.Reset();
	t_domainShader.Reset();
	n_geometryShader.Reset();
	c_geometryShader.Reset();
	m_inputLayout.Reset();
	n_inputLayout.Reset();
	c_inputLayout.Reset();
	m_pixelShader.Reset();
